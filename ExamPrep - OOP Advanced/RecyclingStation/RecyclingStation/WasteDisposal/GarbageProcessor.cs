namespace RecyclingStation.WasteDisposal
{
    ...
    public class GarbageProcessor : IGarbageProcessor
    {
        ...
        public IProcessingData ProcessWaste(IWaste garbage)
        {
            ...
            {
                Type typeOfCorrenspondingStrategy = disposalAttribute.CorrespondindStrategyType;

                IGarbageDisposalStrategy activatedStrategy = (IGarbageDisposalStrategy)Activator.CreateInstance
                    (typeOfCorrenspondingStrategy);
